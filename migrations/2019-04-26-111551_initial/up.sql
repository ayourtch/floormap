...
CREATE TABLE Uploads (
	UploadUUID VARCHAR(32) NOT NULL PRIMARY KEY,
	RelatedToUUID VARCHAR(32) NOT NULL,
	Deleted BOOLEAN NOT NULL,
	CreatedBy VARCHAR NOT NULL,
	CreatedAt datetime NOT NULL,
	UpdatedAt datetime NOT NULL,
	OriginalFileName VARCHAR NOT NULL,
	ServerFileName VARCHAR NOT NULL,
	ServerFileSize INT NOT NULL,
	MimeType VARCHAR NOT NULL,
	Checksum VARCHAR NOT NULL,
	ChecksumType VARCHAR NOT NULL,
	Key1 INT NOT NULL,
	Key2 INT NOT NULL,
	Key3UUID VARCHAR(32) NOT NULL,
	Key4UUID VARCHAR(32) NOT NULL,
